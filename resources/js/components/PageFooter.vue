...
<template>
    <footer>
                ...
                <div class="lg:grid lg:grid-cols-5 md:justify-between">
                    <div class="col-span-2 mb-6 md:mb-0">
                        <a :href="route('welcome')" class="flex items-center">
                            <img
                            :src="`${route('welcome')}/assets/${$page.props.logo.agreed_logo}`"
                                class="mr-3 h-8 bg-white"
                                alt="Agreed Logistics"
                            />
                        </a>
                        <p
                            class="text-gray-100 dark:text-white py-10 lg:pb-2 lg:pt-4 pe-4"
                        >
        ...
        <hr class="border-gray-900 sm:mx-auto dark:border-gray-200" />
        <div
            class="sm:flex sm:items-center sm:justify-between px-16 py-4 bg-zinc-950"
        >
            <span
                class="text-sm text-gray-100 sm:text-center dark:text-gray-50"
                >© {{ new Date().getFullYear() }}
                <a :href="route('welcome')" class="hover:underline"
                    >{{ $page.props.copyright.copyright }}</a
                >. All Rights Reserved.
            </span>
            <div class="flex text-sm mt-4 space-x-6 sm:justify-center sm:mt-0">
                <a
                aria-label="Linkedin"
                    :href="$page.props.copyright.linkedin ?? ''"
                     target="_blank"
  ...
  <path d="M0 1.146C0 .513.526 0 1.175 0h13.65C15.474 0 16 .513 16 1.146v13.708c0 .633-.526 1.146-1.175 1.146H1.175C.526 16 0 15.487 0 14.854V1.146zm4.943 12.248V6.169H2.542v7.225h2.401zm-1.2-8.212c.837 0 1.358-.554 1.358-1.248-.015-.709-.52-1.248-1.342-1.248-.822 0-1.359.54-1.359 1.248 0 .694.521 1.248 1.327 1.248h.016zm4.908 8.212V9.359c0-.216.016-.432.08-.586.173-.431.568-.878 1.232-.878.869 0 1.216.662 1.216 1.634v3.865h2.401V9.25c0-2.22-1.184-3.252-2.764-3.252-1.274 0-1.845.7-2.165 1.193v.025h-.016a5.54 5.54 0 0 1 .016-.025V6.169h-2.4c.03.678 0 7.225 0 7.225h2.4z"></path>
                ...
                <a :href="$page.props.copyright.website??''"
                aria-label="Website"
                    class="text-gray-100 hover:text-gray-400 dark:hover:text-white">
                    <svg
                        class="w-4 h-4"
